...
class GoogleTagService
{
    ...
    {
        /** @var Customer $user */
        $user = $this->requestStack->getCurrentRequest()->getSession()->getCustomerUser();
    ...
    protected function getPageName($view)
    {
        ...
        return $pageEntity->setLocale($this->requestStack->getCurrentRequest()->getSession()->getLang()->getLocale())->getTitle();
    }
    ...
    protected function getOrderTotalAmount($view)
    {
        switch ($view) {
            case 'cart' :
            case 'order-delivery' :
                return $this->requestStack->getCurrentRequest()->getSession()->getSessionCart()->getTotalAmount();
            case 'order-placed' :
                $order = OrderQuery::create()->findPk($this->requestStack->getCurrentRequest()->get('order_id'));
